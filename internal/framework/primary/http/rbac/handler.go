...
func (h *rbacHandler) createRole(c *fiber.Ctx) error {
	tracedCtx, span := tracing.StartSpan(c.UserContext(), "internal:framework:primary:http:rbac:handler:createRole")
	defer span.End()
	c.SetUserContext(tracedCtx)
...
func (h *rbacHandler) updateRole(c *fiber.Ctx) error {
	tracedCtx, span := tracing.StartSpan(c.UserContext(), "internal:framework:primary:http:rbac:handler:updateRole")
	defer span.End()
	c.SetUserContext(tracedCtx)
...
func (h *rbacHandler) deleteRole(c *fiber.Ctx) error {
	tracedCtx, span := tracing.StartSpan(c.UserContext(), "internal:framework:primary:http:rbac:handler:deleteRole")
	defer span.End()
	c.SetUserContext(tracedCtx)
...
func (h *rbacHandler) getPermissions(c *fiber.Ctx) error {
	tracedCtx, span := tracing.StartSpan(c.UserContext(), "internal:framework:primary:http:rbac:handler:getPermissions")
	defer span.End()
	c.SetUserContext(tracedCtx)
