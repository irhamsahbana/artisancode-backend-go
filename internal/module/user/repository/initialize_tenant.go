...
func (r *userRepo) ExistsTenantByCode(ctx context.Context, code string) (bool, error) {
	ctx, span := tracing.StartSpan(ctx, "repo.ExistsTenantByCode")
	defer span.End()
...
func (r *userRepo) InsertTenant(ctx context.Context, tenant coreentity.Tenant) (string, error) {
	ctx, span := tracing.StartSpan(ctx, "repo.InsertTenant")
	defer span.End()
...
func (r *userRepo) InitializeTenant(ctx context.Context, tenantID string, companyName string) (string, error) {
	ctx, span := tracing.StartSpan(ctx, "repo.InitializeTenant")
	defer span.End()
...
func (r *userRepo) insertDefaultCompany(ctx context.Context, tx *sqlx.Tx, tenantID string, companyName string) (string, error) {
	ctx, span := tracing.StartSpan(ctx, "repo.insertDefaultCompany")
	defer span.End()
...
func (r *userRepo) copyRoles(ctx context.Context, tx *sqlx.Tx, tenantID string) error {
	ctx, span := tracing.StartSpan(ctx, "repo.copyRoles")
	defer span.End()
...
func (r *userRepo) copyPermissions(ctx context.Context, tx *sqlx.Tx, tenantID string) error {
	ctx, span := tracing.StartSpan(ctx, "repo.copyPermissions")
	defer span.End()
...
func (r *userRepo) copyRolePermissions(ctx context.Context, tx *sqlx.Tx, tenantID string) error {
	ctx, span := tracing.StartSpan(ctx, "repo.copyRolePermissions")
	defer span.End()
